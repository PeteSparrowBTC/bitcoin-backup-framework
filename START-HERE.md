...
| **A box to throw it into** | A shoe box on a table. The walls bounce the die, so a throw cannot carry the face it started on, and they keep it off the floor. Any box you already have ([how to throw it](https://github.com/PeteSparrowBTC/dice-to-seed#how-to-throw-it)) |
...
1. Roll **60** times, filling every box, whether this sheet is a cosigner seed
   ...
   die into the box rather than across the table, so it bounces and stays in
   front of you. Write each throw onto the sheet **as it lands**: not copied
